...
const postback = function (title, payload) {
  if (typeof title !== 'string') {
    throw TypeError(`[sendkit.messenger#postback] 'title' must be a string.`)
  }

  if (typeof payload !== 'string') {
    throw TypeError(`[sendkit.messenger#postback] 'payload' must be a string.`)
  }
...
const generic_template = function (elements) {
  if (typeof elements !== 'object') {
    throw TypeError(`[sendkit.messenger#generic_template] 'elements' must be an array or an object (for single elements).`)
  }
...
const image = function (url) {
  if (typeof url !== 'string') {
    throw TypeError(`[sendkit.messenger#image] 'url' must be a string.`)
  }
...
const button_template = function (text, buttons) {
  if (typeof text !== 'string') {
    throw TypeError(`[sendkit.messenger#image] 'text' must be a string.`)
  }

  if (typeof buttons !== 'object') {
    throw TypeError(`[sendkit.messenger#button_template] 'buttons' must be an array or an object (for single buttons).`)
  }
