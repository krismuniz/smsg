...
const quick_reply = function (title, payload) {
  if (typeof title !== 'string') {
    throw TypeError(`[smsg#quick_reply] 'title' must be a string.`)
  }

  if (typeof payload !== 'string') {
    throw TypeError(`[smsg#quick_reply] 'payload' must be a string.`)
  }
...
const quick_replies = function (message, replies) {
  if (typeof replies !== 'object') {
    throw TypeError(`[smsg#quick_replies] 'replies' must be an array or an object (for a single quick_reply).`)
  }

  if (typeof message === 'string') {
    replies = replies instanceof Array ? replies : [replies]
    return {
      text: message,
      quick_replies: replies
    }
  } else if (typeof message === 'object') {
    message.quick_replies = replies instanceof Array ? replies : [replies]
    return message
  }
}
